...
const res_company: Company = { id: "", name: "", domain: "", adress: "" };
    ...
    <OverlayTrigger
      ...
      overlay={
        <Tooltip id="button-tooltip-2">
          Recherchez une entreprise ou un utilisateur par son ID
        </Tooltip>
      }
      children={
          ...
          <Button
            ...
            onClick={async () => {
              ...
              if (result_u.first_name !== "") {
                ...
                alert(
                  "L'utilisateur " +
                    result_u.first_name[0] +
                    " " +
                    result_u.last_name[0] +
                    " a été trouvé !"
                );
...
export { SearchCompany, SearchUser, InputSearch, SearchHomepage };
