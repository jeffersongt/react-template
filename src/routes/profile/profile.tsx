...
const arrExperience: JSX.Element[] = [];
const arrCompetence: JSX.Element[] = [];
                ...
                <Form>
                  <Form.Group className="mb-3" controlId="formBasicEmail">
                    ...
                    <Form.Control
                      ...
                      onChange={(e) => {
                        updateInfos.first_name = e.target.value;
                  ...
                  <Form.Group className="mb-3" controlId="formBasicPassword">
                    ...
                    <Form.Control
                      ...
                      onChange={(e) => {
                        updateInfos.last_name = e.target.value;
                  ...
                  <Form.Group className="mb-3" controlId="formBasicPosition">
                    ...
                    <Form.Control
                      ...
                      onChange={(e) => {
                        updateInfos.position = e.target.value;
                  ...
                  <Form.Group className="mb-3" controlId="formBasicCity">
                    ...
                    <Form.Control
                      ...
                      value={updateCompany}
                      onChange={(e) => {
                        updateInfos.company = e.target.value;
                  ...
                  <Form.Group className="mb-3" controlId="formBasicCity">
                    ...
                    <Form.Control
                      ...
                      value={updateCity}
                      onChange={(e) => {
                        updateInfos.city = e.target.value;
      ...
      <Row>
        <Col md={11} className="profile__infos__content">
          <Image
            ...
            src="https://cdn.futura-sciences.com/buildsv6/images/mediumoriginal/1/6/4/1642c0dc85_50184905_bored-ape-yatch-club-2344.jpg"
            roundedCircle
          />
          <br />
          <a style={{ fontWeight: "bold", fontSize: 28 }}>
          ...
          <OverlayTrigger
            ...
            overlay={
              <Tooltip id="button-tooltip-2">
                Ceci est votre id unique personnel, communiquez le à votre
                employeur pour être ajouté à votre entreprise
              </Tooltip>
            }
            children={
...
function UpdateExperiences(props: {
  id: string;
  position: string;
  company: string;
  city: string;
          ...
          <Form>
            <Form.Group className="mb-3" controlId="formBasicPosition">
              ...
              <Form.Control
                ...
                value={updatePosition}
                onChange={(e) => {
                  updateExperience.position = e.target.value;
                  setUpdatePosition(e.target.value);
                }}
              />
            </Form.Group>
            ...
            <Form.Group className="mb-3" controlId="fo rmBasicLocation">
              ...
              <Form.Control
                ...
                value={updateCity}
                onChange={(e) => {
                  updateExperience.city = e.target.value;
                  setUpdateCity(e.target.value);
                }}
              />
            </Form.Group>
            ...
            <div key={result.id[i]}>
              ...
              <Row>
                <Col md={11}>
                  ...
                  <br />
                  <a style={{ opacity: 0.7, fontSize: 18 }}>{result.city[i]}</a>
                </Col>
            ...
            <Form>
              <Form.Group className="mb-3" controlId="formBasicPosition">
                ...
                <Form.Control
                  ...
                  value={Position}
                  onChange={(e) => {
                    addExperience.position = e.target.value;
              ...
              <Form.Group className="mb-3" controlId="formBasicCompany">
                ...
                <Form.Control
                  ...
                  value={Company}
                  onChange={(e) => {
                    addExperience.company = e.target.value;
              ...
              <Form.Group className="mb-3" controlId="fo rmBasicLocation">
                ...
                <Form.Control
                  ...
                  value={City}
                  onChange={(e) => {
                    addExperience.city = e.target.value;
...
function CreateCompetence() {
  ...
  const addCompetence: Competence = { id: "", competence: "" };
          ...
          <Form>
            <InputGroup className="mb-3">
              <FormControl
                ...
                value={Competence}
                onChange={(e) => {
                  addCompetence.competence = e.target.value;
