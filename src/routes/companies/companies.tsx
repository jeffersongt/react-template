...
const arrCompanies: JSX.Element[] = [];
const arrEmployees: JSX.Element[] = [];
...
function CompaniesUpdate(props: {
  ...
  const updateCompany: Company = { id: "", name: "", domain: "", adress: "" };
          ...
          <Form>
            ...
            <Form.Group className="mb-3" controlId="formBasicPassword">
              ...
              <Form.Control
                ...
                value={updateDomain}
                onChange={(e) => {
                  updateCompany.domain = e.target.value;
                  setUpdateDomain(e.target.value);
                }}
              />
            </Form.Group>
            ...
            <Form.Group className="mb-3" controlId="formBasicPosition">
              ...
              <Form.Control
                ...
                value={updateAdress}
                onChange={(e) => {
                  updateCompany.adress = e.target.value;
            ...
            <div key={result.id[i]}>
              ...
              <Row>
                <Col md={11}>
                  ...
                  <br />
                  <a style={{ opacity: 0.7, fontSize: 20 }}>
                    {result.domain[i]}
                  </a>
                  <br />
                  <a>{result.adress[i]}</a>
                ...
                <Col md={1} style={{ alignItems: "flex-end" }}>
                  <CompaniesUpdate
                    id={result.id[i]}
                    name={result.name[i]}
                    domain={result.domain[i]}
                    adress={result.adress[i]}
                  />
                </Col>
              </Row>
            </div>
  ...
  return (
    <>
      ...
      <Container className="companies__my">
        <Row>
          <Col md={4}>
            <h3 style={{ fontWeight: "normal", marginTop: 15 }}>
              Mes entreprises
            </h3>
          </Col>
        </Row>
